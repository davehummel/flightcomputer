...
class PID {
  public:
    PID(double kP, double kI, double kD, int32_t maxOutput = 127, int32_t period = 0, int32_t maxIntegralComponent = 64)
  ...
  private:
    ...
    const int32_t maxOutput, period;
    const int32_t maxIntegral;
    int32_t integral;
    int32_t prevState;
    int32_t derivative;
};
